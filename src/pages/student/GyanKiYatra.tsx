...
const QUESTIONS: Question[] = [
  ...
  { id: 18, question: "यदि किसी वृत्त की त्रिज्या 7 cm है, तो क्षेत्रफल क्या होगा? (π = 22/7)", options: ["154 cm²", "44 cm²", "78 cm²", "132 cm²"], correct: 0, explanation: "क्षेत्रफल = πr² = (22/7) × 7² = 22 × 7 = 154 cm²" },
